...
{
    private:
            char name[30],gender[30],face[30],crime[30],court[30],address[75],jname[30],adate[30],rdate[30],victim[30],vadd[75];
            int n,y,act,jnum,contact,punishment;
...
{
    int i=0,j=0,c;
    char uname[10],p[10]="skram",q[10]="1234";
    char pword[10];
    do
    {
        cout<<"\n\n\n\n\n\t~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~"<<endl;
...
{       
        cout<<"Convicts Code(non zero integer):\t";
      ...
      cin.ignore(10000,'\n');
        ...
        cout<<"enter valid convict code:";
    
		}
		while(n<1)
		{cout<<endl;
		cout<<"\tINVALID ENTRY(ID is negative)!!"<<endl;
		cout<<"enter valid convict ID:";
		cin>>n;
		}
        cout<<endl;
      ...
      cin.ignore(10000,'\n');
		cout<<endl;
		cout<<"\tINVALID ENTRY!!"<<endl;
        cout<<"enter valid convict's age:";
        ...
        cout<<endl;
        cout<<"Guilty under which IPC(1-576)?:\t";
        while(!(cin>>act))
        { 
      ...
      cin.ignore(10000,'\n');
		...
		while(punishment<1950||punishment>2023 )
		{cout<<endl;
		cout<<"\t INVALID ENTRY!!"<<endl;
		cout<<"enter valid punishment year:";
		cin>>punishment;
		}
        cout<<endl;
        cout<<"Jail name:\t";
      ...
      cin.ignore(10000,'\n');
		cout<<endl;
		cout<<"\tINVALID ENTRY!!"<<endl;
        cout<<"enter valid jail number:";
    
		}
		while(jnum<=0)
		{cout<<endl;
		cout<<"enter valid jail number(natural number):";
		cin>>jnum;
		}
        cout<<endl;
        ...
        cout<<"Victim's Relative contact:\t";
        int numcount;
		do
		{
		...
		cout<<endl;
		cout<<"\tINVALID ENTRY!!"<<endl;
        cout<<"enter valid Contact number of victim's relative':";
    }
        
        int contactcopy= contact;
    numcount = 0;
do {
    contactcopy /= 10;
    ++numcount;
  } while (contactcopy != 0);
  if(numcount!=8 && numcount!=10)
  {
  cout<<"\nINVALID NUMBER!!";
  cout<<"\n enter valid 8 or 10 digit number:";}  
}while(numcount!=8 &&numcount!=10);
